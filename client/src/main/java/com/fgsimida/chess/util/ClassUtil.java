...
public class ClassUtil {
    ...
    public static Set<Class<?>> findClassByIntefaceAndPackage(String packageName, Class z){
        Set<Class<?>> classes = getClasses(packageName);
        if (classes == null) {
            return null;
        } else {
            // 某类或者接口的子类
            return getByInterface(z,classes);
        }
    }

    public static Set<Class<?>> findClassByAnnotationAndPackage(String packageName,Class z){
        Set<Class<?>> classes = getClasses(packageName);
        if (classes == null) {
            return null;
        } else {
            // 某类或者接口的子类
            return getByAnnotation(z,classes);
        }
    }
...
//                    System.err.println("jar类型的扫描");
    ...
    public static Set<Class<?>> getByAnnotation(Class clazz, Set<Class<?>> classesAll) {
